...
// Module-level cache: survives component unmount so navigation is instant
let cachedRecords: WasteRecord[] | null = null;

export function useWasteRecords() {
    const [records, setRecords] = useState<WasteRecord[]>(cachedRecords || []);
